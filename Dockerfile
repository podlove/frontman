...
# for purgecss
COPY --from=elixir_prep /app/lib/frontman_web/templates /app/lib/frontman_web/templates
COPY --from=elixir_prep /app/lib/frontman_web/views /app/lib/frontman_web/views
